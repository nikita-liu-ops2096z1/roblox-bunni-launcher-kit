#!/usr/bin/env python3
"""Roblox-bunni-launcher screen analysis tool with overlay and hotkeys."""
import argparse
import logging
import threading
import time
...
class Robloxbunnilauncherkit:
 ...
 def start(self):
 log.info("roblox-bunni-launcher-kit starting...")
 ...
 self.overlay.close()
 self.hotkeys.stop()
 log.info("roblox-bunni-launcher-kit stopped")
...
def main():
 ...
 app = Robloxbunnilauncherkit(args.config)
 app.start()
